          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _buildSection(context, lang, 'Contact Support', [
                  _buildProfileItem(icon: Icons.phone, title: 'Call Us', onTap: () => launchUrl(Uri.parse('tel:6363788419'))),
                  _buildProfileItem(icon: Icons.email_outlined, title: 'Email Support', onTap: () => launchUrl(Uri.parse('mailto:nagunagu78419@gmail.com'))),
                  _buildProfileItem(icon: FontAwesomeIcons.instagram, title: 'Follow Instagram', onTap: () => launchUrl(Uri.parse('https://instagram.com/transify__bookings'))),
                  _buildProfileItem(icon: FontAwesomeIcons.whatsapp, title: 'WhatsApp Us', onTap: () => launchUrl(Uri.parse('https://wa.me/916363788419'))),
                ]),
                const SizedBox(height: 32),
                ElevatedButton.icon(
